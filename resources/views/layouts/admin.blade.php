        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/admin/products"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{ url('admin/categories') }}">Create Category</a>
                            </li>
                    ...
                    \ <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{url ('admin/products/create')}}">Create Products</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{url ('admin/bill')}}">All Bill</a>
                            </li>
                            <li>
                                <a href="{{url ('admin/bill/edit')}}">Edit</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
